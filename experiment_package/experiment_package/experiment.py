...
class Experiment:
    ...
    def create_map(self):
        ...
        self.gz_control.spawn_obstacle_by_url("obstacle3", self.control_factors["obstacle_path"], self.control_factors["obstacle3_pose"])
        self.gz_control.spawn_obstacle_by_url("obstacle4", self.control_factors["obstacle_path"], self.control_factors["obstacle4_pose"])
    ...
    def reset_environment(self, input_factors):
        ...
        self.nav_control.change_nav2_parameter("FollowPath.PathAlign.scale", ParameterType.PARAMETER_DOUBLE, input_factors["path_align"])
        self.nav_control.change_nav2_parameter("FollowPath.GoalAlign.scale", ParameterType.PARAMETER_DOUBLE, input_factors["goal_align"])
    ...
    def do_trial(self, trial):
        path_align = float(trial[0])
        goal_align = float(trial[1])
        index = int(trial[2])
